 ...
 \chapter{Variables and Arithmetic}
  ...
  \subsection{Trigraphs}
   ...
   Trigraphs are a sequence of three ISO 646 characters that get
    ...
    Table 2.1 below shows the trigraphs defined in the Standard.
  ...
  \subsection{Printing real numbers}
   ...
   The usual output function, \texttt{printf}, can be used to format
    ...
    \begin{longtable}[htb]{ll}
      ...
      \bottomrule
      \caption{\label{tab:formatCodesR} Format codes for real numbers}
    \end{longtable}
   ...
   Once again you can use \texttt{printf} to print these various types.
    ...
    \\
     ...
     \texttt{\%lu \%lx \%lo} & as above, but for \klong{}s    \\
      \bottomrule
      \caption{\label{tab:formatCodesI} More format codes}
   \end{longtable}
  ...
  \subsection{Operators}
   ...
   \subsubsection{The bitwise operators}
    ...
    \begin{longtable}{lll}
      ...
      \bottomrule
      \caption{\label{tab:bitOps} Bitwise operators}
    \end{longtable}
...
\end{Verbatim}
    ...
    \begin{longtable}{lll}
      ...
      \texttt{>{}>=} & \texttt{<{}<=} &                 \\
      \bottomrule
      \caption{\label{tab:compAssign} Compound assignment operators}
    \end{longtable}
...
\multicolumn{3}{p{0.9\textwidth}}{2. This is unusual. See Section 3.4.1.}\\
      \bottomrule
      \caption{\label{tab:opPrecAssoc} Operator precedence and associativity}
\end{longtable}
 ...
 \chapter{Control of Flow and Logical Expressions}
  ...
  \subsection{Logical expressions and Relational Operators}
   ...
   \begin{longtable}[htb]{ll}
     ...
     \texttt{!=} & not equal to    \\
      \bottomrule
      \caption{\label{tab:relOp} Relational operators}
   \end{longtable}
...
\end{Verbatim}
  ...
  \begin{longtable}{lll}
    ...
    \bottomrule
    \caption{\label{tab:linkAcc} Linkage and accessibility}
  \end{longtable}
  ...
  Here are the combinations of the use of the keywords, the types of
   ...
   \begin{longtable}{lllll}
     ...
     is taken to be a default initialization of zero.}\\
      \bottomrule
      \caption{\label{tab:sumLink} Summary of Linkage}
   \end{longtable}
...
\end{Verbatim}
  ...
  \subsection{Pointers and increment operators}
   ...
   \begin{longtable}{ll}
     ...
     \bottomrule
     \caption{\label{tab:pointer} Pointer notation}
   \end{longtable}
   ...
   The expressions in the list above can usually be understood after
    ...
    \begin{longtable}[thb]{ll}
      ...
      \texttt{*(++p)}  & \texttt{*++p}   \\
      \bottomrule
      \caption{\label{tab:pointer2} More pointer notation}
    \end{longtable}
   ...
   \subsubsection{Duration}
    ...
    So, the duration of an object depends on the storage class specifier
     ...
     \begin{longtable}{llll}
       \hspace{0pt} \\
       \toprule
       Storage Class   & Function or Data & Linkage           & Duration \\
       Specifier       & Object           &                   &          \\
       \midrule
    ...
    %5\begin{adjustbox}{width={\textwidth}}
    \begin{longtable}{llll}
      \hspace{0pt} \\
      \toprule
      Storage Class   & Function or Data & Linkage           & Duration \\
      ...
      none        & function         & probably external & static    \\
      \bottomrule
      \caption{\label{tab:intDecl} Internal declarations}
    \end{longtable}
    % \end{adjustbox}
  ...
  \subsection{Limits.h}
   ...
   Table 9.1 gives the names declared, the allowable values,
    ...
    \begin{longtable}{llp{0.4\textwidth}}
      ...
      \texttt{UCHAR\_MAX}.}\\
      \bottomrule
      \caption{\label{tab:limits.h} \texttt{<limits.h>}}
    \end{longtable}
    %\end{adjustbox}
    %\end{center}
 ...
 %\begin{adjustbox}{width={\textwidth}}
    \begin{longtable}{llp{0.5\textwidth}}
     ...
     \texttt{FLT\_DIG}            & ($\geq$6)       & the number of digits of precision in a \float{}  \\
      ...
      \bottomrule
      \caption{\label{tab:float.h} \texttt{<float.h>}}
\end{longtable}
%\end{adjustbox}
...
\end{Verbatim}
   ...
   The Standard list of modes is shown in Table 9.3,  although
    ...
    \begin{longtable}{llllll}
      ...
      \texttt{"ab+"} & binary & no  & yes & yes & no  \\
      \bottomrule
      \caption{\label{tab:modeFileOpen} File opening modes}
     \end{longtable}
...
\end{Verbatim}
   ...
   \begin{longtable}{lp{0.8\textwidth}}
     ...
     \bottomrule
     \caption{\label{tab:typeBuf} Type of buffering}
    \end{longtable}
...
\end{Verbatim}
   ...
   \end{description}
    ...
    %\begin{adjustbox}{width={\textwidth}}
      \begin{longtable}{lp{0.65\textwidth}p{0.15\textwidth}}
        \hspace{0pt} \\
        \toprule
...
\end{Verbatim}
    ...
    \begin{longtable}{lp{0.8\textwidth}}
      ...
      \texttt{vsprintf} & Formatted output  as  for  \texttt{sprintf},  but
                          ...
                          \texttt{va\_end}  is not called by this function.  \\
      \bottomrule
      \caption{\label{tab:funFormOut} Functions performing formatted output}
      \end{longtable}
      % \end{adjustbox}
      % \begin{center}
      %   \textit{Table 9.6. Functions performing formatted output}
      % \end{center}
