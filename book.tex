...
\begin{center}\textit{Figure 1.1. Separate compilation}\end{center}
  ...
  \VerbatimInput{example/example1-1.c}\begin{center}\textit{Example 1.1}\end{center}
...
\end{Verbatim}
  ...
  \subsection{A program to find prime numbers}
   ...
   \VerbatimInput{example/example1-2.c}\begin{center}\textit{Example 1.2}\end{center}
...
\end{Verbatim}
  ...
  \subsection{An example performing input}
   ...
   \VerbatimInput{example/example1-3.c}\begin{center}\textit{Example 1.3}\end{center}
...
\end{Verbatim}
   ...
   \VerbatimInput{example/example1-4.c}\begin{center}\textit{Example 1.4}\end{center}
...
\end{Verbatim}
   ...
   The \texttt{char} type is specified by the Standard as suitable to
...
\end{Verbatim}
  ...
  \VerbatimInput{example/example2-1.c}\begin{center}\textit{Example 2.1}\end{center}
...
\begin{center}\textit{Table 2.4. Format codes for real numbers}\end{center}
   ...
   \VerbatimInput{example/example2-2.c}\begin{center}\textit{Example 2.2}\end{center}
  ...
  \subsection{Character variables}
   ...
   \VerbatimInput{example/example2-3.c}\begin{center}\textit{Example 2.3}\end{center}
...
\end{Verbatim}
   ...
   \VerbatimInput{example/example2-4.c}\begin{center}\textit{Example 2.4}\end{center}
   ...
   \VerbatimInput{example/example2-5.c}\begin{center}\textit{Example 2.5}\end{center}
  ...
  \subsection{More complicated types}
   ...
   \VerbatimInput{example/example2-6.c}\begin{center}\textit{Example 2.6}\end{center}
...
\end{Verbatim}
   ...
   In the last three, the \texttt{signed} keyword is unnecessary
...
\end{Verbatim}
  ...
  \subsection{Conversions}
   ...
   \subsubsection{The usual arithmetic conversions}
    ...
    \VerbatimInput{example/example2-7.c}\begin{center}\textit{Example 2.7}\end{center}
...
\begin{center}\textit{Table 2.6. Casts}\end{center}
...
\begin{center}\textit{Table 2.7. Bitwise operators}\end{center}
    ...
    \VerbatimInput{example/example2-9.c}\begin{center}\textit{Example 2.9}\end{center}
...
\end{Verbatim}
    ...
    \VerbatimInput{example/example2-10.c}\begin{center}\textit{Example 2.10}\end{center}
...
\begin{enumerate}
 ...
 \chapter{Control of Flow and Logical Expressions}
...
\begin{center}\textit{Table 3.1. Relational operators}\end{center}
...
\end{Verbatim}
   ...
   \VerbatimInput{example/example3-4.c}\begin{center}\textit{Example 3.4}\end{center}
...
\end{Verbatim}
   ...
   \VerbatimInput{example/example3-5.c}\begin{center}\textit{Example 3.5}\end{center}
  ...
  \subsection{The break statement}
   ...
   \VerbatimInput{example/example3-7.c}\begin{center}\textit{Example 3.7}\end{center}
...
\end{Verbatim}
   ...
   \VerbatimInput{example/example3-9.c}\begin{center}\textit{Example 3.9}\end{center}
...
\end{Verbatim}
  ...
  \textbf{Exercise 3.5.} Why is \texttt{continue} not very useful in
...
\end{Verbatim}
  ...
  \subsection{The return statement}
   ...
   The \texttt{return} statement is very important. Every function
...
\VerbatimInput{example/example4-2.c}\begin{center}\textit{Example 4.2}\end{center}
...
\VerbatimInput{example/example4-5.c}\begin{center}\textit{Example 4.5}\end{center}
...
\VerbatimInput{example/example4-8.c}\begin{center}\textit{Example 4.8}\end{center}
...
\begin{center}\textit{Table 4.1. Linkage and accessibility}\end{center}
...
\VerbatimInput{example/example4-9.c}\begin{center}\textit{Example 4.9}\end{center}
...
\VerbatimInput{example/example4-10.c}\begin{center}\textit{Example 4.10}\end{center}
...
\VerbatimInput{example/example4-11.c}\begin{center}\textit{Example 4.11}\end{center}

   They can help detect excessive recursion:

\VerbatimInput{example/example4-12.c}\begin{center}\textit{Example 4.12}\end{center}
...
\end{Verbatim}
   ...
   \begin{figure*}\centering\includegraphics[type=pdf,read=.pdf,ext=.pdf,scale=1.0]{figure/5.2}\caption{Diagram showing a two dimensional array, with the 'outer' array            having two elements labelled 't\_d[0]' and 't\_d[1]', each with            three elements within it, labelled 't\_d[0][0]', etc.}\end{figure*}
...
\end{Verbatim}
   ...
   \VerbatimInput{example/example5-1.c}\begin{center}\textit{Example 5.1}\end{center}
   ...
   \VerbatimInput{example/example5-2.c}\begin{center}\textit{Example 5.2}\end{center}
...
\begin{center}\textit{Figure 5.5. Just as $\backslash$texttt\{date\} is called}\end{center}
...
\begin{center}\textit{Figure 5.6. Just as $\backslash$texttt\{date\} is about to return}\end{center}
...
\end{Verbatim}
   ...
   \VerbatimInput{example/example5-3.c}\begin{center}\textit{Example 5.3}\end{center}
...
\end{Verbatim}
  ...
  \subsection{Pointer arithmetic}
   ...
   \VerbatimInput{example/example5-4.c}\begin{center}\textit{Example 5.4}\end{center}
   ...
   \VerbatimInput{example/example5-5.c}\begin{center}\textit{Example 5.5}\end{center}
...
\end{Verbatim}
  ...
  \VerbatimInput{example/example5-6.c}\begin{center}\textit{Example 5.6}\end{center}
...
\end{Verbatim}
   ...
   \begin{figure*}\centering\includegraphics[type=pdf,read=.pdf,ext=.pdf,scale=1.0]{figure/5.7}\caption{Diagram showing an unnamed array of 'const char' values, where the            last item has the value '0', and showing that a 'const char *'            value that points to the first of them can be used as a string.}\end{figure*}
...
\begin{center}\textit{Figure 5.7. Effect of using a string}\end{center}
   ...
   \VerbatimInput{example/example5-8.c}\begin{center}\textit{Example 5.8}\end{center}
...
\end{Verbatim}
   ...
   \VerbatimInput{example/example5-9.c}\begin{center}\textit{Example 5.9}\end{center}
...
\begin{center}\textit{Table 5.1. Pointer notation}\end{center}
...
\end{Verbatim}
  ...
  The fundamental unit of storage in C is the \texttt{char}, and by
   definition
...
\end{Verbatim}
  ...
  \VerbatimInput{example/example5-10.c}\begin{center}\textit{Example 5.10}\end{center}
  ...
  \VerbatimInput{example/example5-11.c}\begin{center}\textit{Example 5.11}\end{center}
  ...
  \VerbatimInput{example/example5-12.c}\begin{center}\textit{Example 5.12}\end{center}
  ...
  \VerbatimInput{example/example5-13.c}\begin{center}\textit{Example 5.13}\end{center}
  ...
  \subsection{What sizeof can't do}
   ...
   \VerbatimInput{example/example5-14.c}\begin{center}\textit{Example 5.14}\end{center}
...
\end{Verbatim}
  ...
  \VerbatimInput{example/example5-16.c}\begin{center}\textit{Example 5.16}\end{center}
  ...
  \VerbatimInput{example/example5-17.c}\begin{center}\textit{Example 5.17}\end{center}
...
\end{Verbatim}
  ...
  \subsection{Arithmetic}
   ...
   It the pointer resulting from the addition points in front of the
...
\end{Verbatim}
  ...
  The examples of the use of \texttt{sizeof} should help to eliminate
...
\end{Verbatim}
  ...
  \VerbatimInput{example/example6-1.c}\begin{center}\textit{Example 6.1}\end{center}
...
\end{Verbatim}
   ...
   \VerbatimInput{example/example6-3.c}\begin{center}\textit{Example 6.3}\end{center}
   ...
   \VerbatimInput{example/example6-4.c}\begin{center}\textit{Example 6.4}\end{center}
...
\end{Verbatim}
   ...
   \VerbatimInput{example/example6-5.c}\begin{center}\textit{Example 6.5}\end{center}
   ...
   \VerbatimInput{example/example6-6.c}\begin{center}\textit{Example 6.6}\end{center}
   ...
   \VerbatimInput{example/example6-7.c}\begin{center}\textit{Example 6.7}\end{center}
...
\end{Verbatim}
   ...
   \VerbatimInput{example/example6-8.c}\begin{center}\textit{Example 6.8}\end{center}
   ...
   \VerbatimInput{example/example6-9.c}\begin{center}\textit{Example 6.9}\end{center}
   ...
   \VerbatimInput{example/example6-10.c}\begin{center}\textit{Example 6.10}\end{center}
  ...
  \VerbatimInput{example/example6-11.c}\begin{center}\textit{Example 6.11}\end{center}
  ...
  \VerbatimInput{example/example6-12.c}\begin{center}\textit{Example 6.12}\end{center}
  ...
  \VerbatimInput{example/example6-13.c}\begin{center}\textit{Example 6.13}\end{center}
...
\end{Verbatim}
   ...
   \VerbatimInput{example/example6-15.c}\begin{center}\textit{Example 6.15}\end{center}
   ...
   \VerbatimInput{example/example6-16.c}\begin{center}\textit{Example 6.16}\end{center}
   ...
   \VerbatimInput{example/example6-17.c}\begin{center}\textit{Example 6.17}\end{center}
   ...
   \VerbatimInput{example/example6-18.c}\begin{center}\textit{Example 6.18}\end{center}
 ...
 \chapter{Specialized Areas of C}
  ...
  \subsection{Storage class specifiers}
   ...
   \subsubsection{Duration}
    ...
    Although the presence of \texttt{static} in a declaration
...
\VerbatimInput{example/example8-1.c}\begin{center}\textit{Example 8.1}\end{center}
...
\VerbatimInput{example/example8-2.c}\begin{center}\textit{Example 8.2}\end{center}
...
\end{Verbatim}
  ...
  To re-use a name already declared as a \texttt{typedef}, its
...
\end{Verbatim}
  ...
  The keywords \texttt{const} and \texttt{volatile} can be
...
\VerbatimInput{example/example8-3.c}\begin{center}\textit{Example 8.3}\end{center}
...
\VerbatimInput{example/example8-4.c}\begin{center}\textit{Example 8.4}\end{center}
...
\VerbatimInput{example/example8-5.c}\begin{center}\textit{Example 8.5}\end{center}


   The rules about mixing \texttt{volatile} and regular types
...
\begin{center}\textit{Table 9.1. $\backslash$texttt\{<limits.h>\}}\end{center}
...
\begin{center}\textit{Table 9.2. $\backslash$texttt\{<float.h>\}}\end{center}
...
\begin{center}\textit{Table 9.4. Type of buffering}\end{center}
...
\end{Verbatim}
  ...
  \VerbatimInput{example/example10-1.c}\begin{center}\textit{Example 10.1}\end{center}
...
\begin{center}\textit{Figure 10.2. Arguments to a program after incrementing
    $\backslash$texttt\{argv\}}\end{center}
